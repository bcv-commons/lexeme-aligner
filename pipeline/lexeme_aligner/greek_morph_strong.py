...
_TABLE_PATH = Path("config/greek_morph_strong.json")
_MIN_N = 10
_MIN_PURITY = 0.90
...
def build_table(hbo_grc_dir: Path = Path("pipeline/vendor/gbt/hbo+grc"),
                gold_path: Path = Path("pipeline/vendor/resources/strongs/attestations/eng.parquet"),
