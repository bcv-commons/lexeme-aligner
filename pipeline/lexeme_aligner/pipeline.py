...
def main() -> int:
    ...
    ap.add_argument("--usj-dir", type=Path, default=None, help="default pipeline/work/ingest-cache/usj-<iso>")
    ...
    usj = args.usj_dir or Path(f"pipeline/work/ingest-cache/usj-{args.iso}")
    env = dict(os.environ)
    if args.spine_db:
