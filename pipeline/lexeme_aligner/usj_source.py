...
# e.g. "Elimelek ... [Elimelechs namn betyder: 'min Gud är kung'; ...]" — often LONGER than the actual
# translated sentence. Left unstripped this floods eflomal/gloss with non-scripture prose (measured:
# swk gap-fill precision collapsed to ~0.5-0.7% until this was found). Strip innermost-first (loop) so
# accidental nesting doesn't leave a stray bracket; a bare stray "[" or "]" (unbalanced, rare) is left
# as-is rather than risk eating real text.
