...
align_one arb  pipeline/work/ingest-cache/usj-arb        Arabic
align_one arbn pipeline/work/ingest-cache/usj-arbn       "Arabic (NAV)"
align_one asm  pipeline/work/ingest-cache/usj-asm        Assamese
align_one ben  pipeline/work/ingest-cache/usj-ben        Bengali
align_one eng  pipeline/work/ingest-cache/usj-eng        English
align_one engy pipeline/work/ingest-cache/usj-engy       "English (YLT)"
align_one fra  pipeline/work/ingest-cache/usj-fra-lsg    French
align_one hau  pipeline/work/ingest-cache/usj-hau-ohcb   Hausa
align_one hin  pipeline/work/ingest-cache/usj-hin        Hindi
align_one ind  pipeline/work/ingest-cache/usj-ind        Indonesian
align_one rus  pipeline/work/ingest-cache/usj-rus        Russian
align_one spa  pipeline/work/ingest-cache/usj-spa        Spanish
align_one swe  pipeline/work/ingest-cache/usj-swe        Swedish
align_one swk  pipeline/work/ingest-cache/usj-swk        "Swedish (Karnbibeln)"
echo "########## STAGE 1 DONE ##########"
